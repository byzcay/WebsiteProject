...
public partial class RecipeAppContext : DbContext
{
    ...
    public virtual DbSet<Favori2> Favori2s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Favori2>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Favori2__3214EC272AE62FB9");

            entity.ToTable("Favori2");
        ...
        modelBuilder.Entity<Ingredient>(entity =>
        {
            ...
            entity.Property(e => e.Name).HasMaxLength(256);
            entity.Property(e => e.Unit).HasMaxLength(256);
        });
        ...
        modelBuilder.Entity<Recipe>(entity =>
        {
            ...
            entity.Property(e => e.Cuisine).HasMaxLength(256);
            entity.Property(e => e.Description).HasMaxLength(256);
